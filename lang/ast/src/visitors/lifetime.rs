...
pub trait ExprVisitorWithLifetime<'a> {
    type Output: 'a;
...
pub trait TypeVisitorWithLifetime<'a> {
    type Output: 'a;
...
pub trait StmtVisitorWithLifetime<'a> {
    type Output: 'a;
...
pub trait LastStmtVisitorWithLifetime<'a> {
    type Output: 'a;
...
pub trait AstVisitorWithLifetime<'a> {
    type BlockOutput: 'a;
